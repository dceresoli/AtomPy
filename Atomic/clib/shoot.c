/* Generated by Cython 0.11.2 on Sat Apr 24 22:38:14 2010 */
...
typedef __pyx_t_5numpy_double_t __pyx_t_5shoot_double_t;
...
/* Module declarations from shoot */

static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5shoot_double_t = { "shoot.double_t", NULL, sizeof(__pyx_t_5shoot_double_t), 'R' };
#define __Pyx_MODULE_NAME "shoot"
int __pyx_module_is_main_shoot = 0;
...
/* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":4
 * cimport numpy
 * 
 * def init():             # <<<<<<<<<<<<<<
 *         pass
...
static PyObject *__pyx_pf_5shoot_init(PyObject *__pyx_self, PyObject *unused); /*proto*/
static PyObject *__pyx_pf_5shoot_init(PyObject *__pyx_self, PyObject *unused) {
...
/* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":10
 * 
...
static PyObject *__pyx_pf_5shoot_shoot(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5shoot_shoot[] = "\n    Integrate differential equation by shooting method\n\n        u''(x)*c2(x) + u'(x)*c1(x) + u(x)*c0(x) = 0\n\n    on an equispaced grid (spacing dx).\n\n    u[0:2] should be set in input according to boundary conditions.\n\n    Return: u(x), number of nodes, turning point and discontinuity of\n    derivative at the turning point\n    ";
static PyObject *__pyx_pf_5shoot_shoot(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_N;
  PyArrayObject *__pyx_v_u = 0;
  double __pyx_v_dx;
  PyArrayObject *__pyx_v_c2 = 0;
  PyArrayObject *__pyx_v_c1 = 0;
  PyArrayObject *__pyx_v_c0 = 0;
  PyArrayObject *__pyx_v_fp;
  PyArrayObject *__pyx_v_fm;
  PyArrayObject *__pyx_v_f0;
  double __pyx_v_uturn;
  double __pyx_v_uturn1;
  double __pyx_v_dright;
  double __pyx_v_dleft;
  double __pyx_v_scale;
  double __pyx_v_derdisc;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_turn;
  int __pyx_v_nodes;
  PyObject *__pyx_v_all_positive;
  Py_buffer __pyx_bstruct_fp;
  Py_ssize_t __pyx_bstride_0_fp = 0;
  Py_ssize_t __pyx_bshape_0_fp = 0;
  Py_buffer __pyx_bstruct_f0;
  Py_ssize_t __pyx_bstride_0_f0 = 0;
  Py_ssize_t __pyx_bshape_0_f0 = 0;
  Py_buffer __pyx_bstruct_u;
  Py_ssize_t __pyx_bstride_0_u = 0;
  Py_ssize_t __pyx_bshape_0_u = 0;
  Py_buffer __pyx_bstruct_c2;
  Py_ssize_t __pyx_bstride_0_c2 = 0;
  Py_ssize_t __pyx_bshape_0_c2 = 0;
  Py_buffer __pyx_bstruct_c1;
  Py_ssize_t __pyx_bstride_0_c1 = 0;
  Py_ssize_t __pyx_bshape_0_c1 = 0;
  Py_buffer __pyx_bstruct_c0;
  Py_ssize_t __pyx_bstride_0_c0 = 0;
  Py_ssize_t __pyx_bshape_0_c0 = 0;
  Py_buffer __pyx_bstruct_fm;
  Py_ssize_t __pyx_bstride_0_fm = 0;
  Py_ssize_t __pyx_bshape_0_fm = 0;
  PyObject *__pyx_r = NULL;
  PyObject *__pyx_1 = 0;
  PyObject *__pyx_2 = 0;
  ...
  static PyObject **__pyx_pyargnames[] = {&__pyx_kp_N,&__pyx_kp_u,&__pyx_kp_dx,&__pyx_kp_31,&__pyx_kp_32,&__pyx_kp_c0,0};
  __Pyx_SetupRefcountContext("shoot");
  __pyx_self = __pyx_self;
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("shoot", 1, 6, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_kp_dx);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("shoot", 1, 6, 6, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_kp_31);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("shoot", 1, 6, 6, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  4:
      values[4] = PyDict_GetItem(__pyx_kwds, __pyx_kp_32);
      if (likely(values[4])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("shoot", 1, 6, 6, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  5:
      values[5] = PyDict_GetItem(__pyx_kwds, __pyx_kp_c0);
      if (likely(values[5])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("shoot", 1, 6, 6, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "shoot") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_N = __Pyx_PyInt_AsInt(values[0]); if (unlikely((__pyx_v_N == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_u = ((PyArrayObject *)values[1]);
    __pyx_v_dx = __pyx_PyFloat_AsDouble(values[2]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_c2 = ((PyArrayObject *)values[3]);
    __pyx_v_c1 = ((PyArrayObject *)values[4]);
    __pyx_v_c0 = ((PyArrayObject *)values[5]);
  } else if (PyTuple_GET_SIZE(__pyx_args) != 6) {
    goto __pyx_L5_argtuple_error;
  } else {
    __pyx_v_N = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((__pyx_v_N == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_u = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 1));
    __pyx_v_dx = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_c2 = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 3));
    __pyx_v_c1 = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 4));
    __pyx_v_c0 = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 5));
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("shoot", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("shoot.shoot");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_u);
  __pyx_v_fp = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_v_fm = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_v_f0 = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_v_all_positive = Py_None; __Pyx_INCREF(Py_None);
  __pyx_bstruct_fp.buf = NULL;
  __pyx_bstruct_fm.buf = NULL;
  __pyx_bstruct_f0.buf = NULL;
  __pyx_bstruct_u.buf = NULL;
  __pyx_bstruct_c2.buf = NULL;
  __pyx_bstruct_c1.buf = NULL;
  __pyx_bstruct_c0.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_u), __pyx_ptype_5numpy_ndarray, 0, "u", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_c2), __pyx_ptype_5numpy_ndarray, 0, "c2", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_c1), __pyx_ptype_5numpy_ndarray, 0, "c1", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_c0), __pyx_ptype_5numpy_ndarray, 0, "c0", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_u, (PyObject*)__pyx_v_u, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_u = __pyx_bstruct_u.strides[0];
  __pyx_bshape_0_u = __pyx_bstruct_u.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_c2, (PyObject*)__pyx_v_c2, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_c2 = __pyx_bstruct_c2.strides[0];
  __pyx_bshape_0_c2 = __pyx_bstruct_c2.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_c1, (PyObject*)__pyx_v_c1, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_c1 = __pyx_bstruct_c1.strides[0];
  __pyx_bshape_0_c1 = __pyx_bstruct_c1.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_c0, (PyObject*)__pyx_v_c0, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_c0 = __pyx_bstruct_c0.strides[0];
  __pyx_bshape_0_c0 = __pyx_bstruct_c0.shape[0];

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":33
 ...
 *     f0 = (dx*dx)*c0 - 2.0*c2
 */
  __pyx_t_1 = PyFloat_FromDouble((0.5 * __pyx_v_dx)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyNumber_Multiply(__pyx_t_1, ((PyObject *)__pyx_v_c1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Add(((PyObject *)__pyx_v_c2), __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = ((PyArrayObject *)__pyx_t_1);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_fp);
    __pyx_t_4 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_fp, (PyObject*)__pyx_t_3, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_4 < 0)) {
      PyErr_Fetch(&__pyx_t_5, &__pyx_t_6, &__pyx_t_7);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_fp, (PyObject*)__pyx_v_fp, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
    ...
    if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_v_fp));
  __pyx_v_fp = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":34
 * 
 *     fp = c2 + 0.5*dx*c1
 *     fm = c2 - 0.5*dx*c1             # <<<<<<<<<<<<<<
 *     f0 = (dx*dx)*c0 - 2.0*c2
 * 
 */
  __pyx_t_1 = PyFloat_FromDouble((0.5 * __pyx_v_dx)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyNumber_Multiply(__pyx_t_1, ((PyObject *)__pyx_v_c1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Subtract(((PyObject *)__pyx_v_c2), __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = ((PyArrayObject *)__pyx_t_1);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_fm);
    __pyx_t_4 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_fm, (PyObject*)__pyx_t_3, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_4 < 0)) {
      PyErr_Fetch(&__pyx_t_7, &__pyx_t_6, &__pyx_t_5);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_fm, (PyObject*)__pyx_v_fm, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_bstride_0_fm = __pyx_bstruct_fm.strides[0];
    __pyx_bshape_0_fm = __pyx_bstruct_fm.shape[0];
    if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_v_fm));
  __pyx_v_fm = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":35
 *     fp = c2 + 0.5*dx*c1
 *     fm = c2 - 0.5*dx*c1
 *     f0 = (dx*dx)*c0 - 2.0*c2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_dx * __pyx_v_dx)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyNumber_Multiply(__pyx_t_1, ((PyObject *)__pyx_v_c0)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyFloat_FromDouble(2.0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = PyNumber_Multiply(__pyx_t_1, ((PyObject *)__pyx_v_c2)); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Subtract(__pyx_t_2, __pyx_t_8); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = ((PyArrayObject *)__pyx_t_1);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_f0);
    __pyx_t_4 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_f0, (PyObject*)__pyx_t_3, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_4 < 0)) {
      PyErr_Fetch(&__pyx_t_5, &__pyx_t_6, &__pyx_t_7);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_f0, (PyObject*)__pyx_v_f0, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
        Py_XDECREF(__pyx_t_5); Py_XDECREF(__pyx_t_6); Py_XDECREF(__pyx_t_7);
        __Pyx_RaiseBufferFallbackError();
      } else {
        PyErr_Restore(__pyx_t_5, __pyx_t_6, __pyx_t_7);
    ...
    __pyx_bstride_0_f0 = __pyx_bstruct_f0.strides[0];
    __pyx_bshape_0_f0 = __pyx_bstruct_f0.shape[0];
    if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_v_f0));
  __pyx_v_f0 = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":39
 *     # inward integration up to turning point (or one point beyond to get
 ...
 */
  ...
  *__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_9, __pyx_bstride_0_u) = 1.0;

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":40
 *     # derivative). If no turning point, integrate half-way
 *     u[-1] = 1.0
 *     u[-2] = -u[-1]*f0[-1]/fm[-1]             # <<<<<<<<<<<<<<
 *     all_positive = numpy.all(c0 > 0.0)
 ...
 */
  __pyx_t_10 = -1;
  if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_bshape_0_u;
  __pyx_t_11 = -1;
  if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_bshape_0_f0;
  __pyx_t_12 = -1;
  if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_bshape_0_fm;
  __pyx_t_13 = -2;
  if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_bshape_0_u;
  *__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_13, __pyx_bstride_0_u) = (((-(*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_10, __pyx_bstride_0_u))) * (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_f0.buf, __pyx_t_11, __pyx_bstride_0_f0))) / (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_fm.buf, __pyx_t_12, __pyx_bstride_0_fm)));

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":41
 *     u[-1] = 1.0
 *     u[-2] = -u[-1]*f0[-1]/fm[-1]
 *     all_positive = numpy.all(c0 > 0.0)             # <<<<<<<<<<<<<<
 *     for i in xrange(N-2, 0, -1):
 ...
 */
  __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_kp_numpy); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_1);
  __pyx_t_1 = PyObject_GetAttr(__pyx_1, __pyx_kp_all); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_t_8 = PyFloat_FromDouble(0.0); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_2 = PyObject_RichCompare(((PyObject *)__pyx_v_c0), __pyx_t_8, Py_GT); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  ...
  __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_t_1, ((PyObject *)__pyx_t_8), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_8)); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_v_all_positive);
  __pyx_v_all_positive = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":42
 *     u[-2] = -u[-1]*f0[-1]/fm[-1]
 *     all_positive = numpy.all(c0 > 0.0)
 *     for i in xrange(N-2, 0, -1):             # <<<<<<<<<<<<<<
 *         u[i-1] = (-fp[i]*u[i+1] - f0[i]*u[i]) / fm[i]
 *         if abs(u[i-1]) > 1e10:
 */
  for (__pyx_t_4 = (__pyx_v_N - 2); __pyx_t_4 > 0; __pyx_t_4-=1) {
    __pyx_v_i = __pyx_t_4;

    /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":43
 *     all_positive = numpy.all(c0 > 0.0)
 *     for i in xrange(N-2, 0, -1):
 *         u[i-1] = (-fp[i]*u[i+1] - f0[i]*u[i]) / fm[i]             # <<<<<<<<<<<<<<
 *         if abs(u[i-1]) > 1e10:
 ...
 */
    ...
    if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_bshape_0_fp;
    __pyx_t_15 = (__pyx_v_i + 1);
    if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_bshape_0_u;
    __pyx_t_16 = __pyx_v_i;
    if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_bshape_0_f0;
    __pyx_t_17 = __pyx_v_i;
    if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_bshape_0_u;
    __pyx_t_18 = __pyx_v_i;
    if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_bshape_0_fm;
    __pyx_t_19 = (__pyx_v_i - 1);
    if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_bshape_0_u;
    *__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_19, __pyx_bstride_0_u) = ((((-(*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_fp.buf, __pyx_t_14, __pyx_bstride_0_fp))) * (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_15, __pyx_bstride_0_u))) - ((*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_f0.buf, __pyx_t_16, __pyx_bstride_0_f0)) * (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_17, __pyx_bstride_0_u)))) / (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_fm.buf, __pyx_t_18, __pyx_bstride_0_fm)));

    /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":44
 *     for i in xrange(N-2, 0, -1):
 *         u[i-1] = (-fp[i]*u[i+1] - f0[i]*u[i]) / fm[i]
 *         if abs(u[i-1]) > 1e10:             # <<<<<<<<<<<<<<
 *             #u[i-1:] *= 1e-10 # for numerical stability
 ...
 */
    ...
    if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_bshape_0_u;
    __pyx_t_2 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_20, __pyx_bstride_0_u))); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_8 = PyNumber_Absolute(__pyx_t_2); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyFloat_FromDouble(10000000000.0); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = PyObject_RichCompare(__pyx_t_8, __pyx_t_2, Py_GT); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_21 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_21 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (__pyx_t_21) {

      /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":46
 *         if abs(u[i-1]) > 1e10:
 *             #u[i-1:] *= 1e-10 # for numerical stability
 *             for j in xrange(i-1,N): u[j] *= 1e-10             # <<<<<<<<<<<<<<
 *         if c0[i] < 0.0:
 *             turn = i
 */
      for (__pyx_t_22 = (__pyx_v_i - 1); __pyx_t_22 < __pyx_v_N; __pyx_t_22+=1) {
        __pyx_v_j = __pyx_t_22;
        __pyx_t_23 = __pyx_v_j;
        if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_bshape_0_u;
        *__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_23, __pyx_bstride_0_u) *= 1e-10;
      }
      goto __pyx_L8;
    }
    __pyx_L8:;

    /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":47
 *             #u[i-1:] *= 1e-10 # for numerical stability
 *             for j in xrange(i-1,N): u[j] *= 1e-10
 *         if c0[i] < 0.0:             # <<<<<<<<<<<<<<
 *             turn = i
 ...
 */
    ...
    if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_bshape_0_c0;
    __pyx_t_21 = ((*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_c0.buf, __pyx_t_22, __pyx_bstride_0_c0)) < 0.0);
    if (__pyx_t_21) {

      /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":48
 *             for j in xrange(i-1,N): u[j] *= 1e-10
 *         if c0[i] < 0.0:
 *             turn = i             # <<<<<<<<<<<<<<
 *             break
 ...
 */
      __pyx_v_turn = __pyx_v_i;

      /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":49
 *         if c0[i] < 0.0:
 *             turn = i
 *             break             # <<<<<<<<<<<<<<
 *         if all_positive and i == N/2:
 ...
 */
    ...
    /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":50
 *             turn = i
 *             break
 *         if all_positive and i == N/2:             # <<<<<<<<<<<<<<
 *             turn = N/2
 *             break
 */
    __pyx_t_21 = __Pyx_PyObject_IsTrue(__pyx_v_all_positive); if (unlikely(__pyx_t_21 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (__pyx_t_21) {
      __pyx_t_24 = (__pyx_v_i == (__pyx_v_N / 2));
    ...
    if (__pyx_t_25) {
      ...
      /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":51
 *             break
 *         if all_positive and i == N/2:
 *             turn = N/2             # <<<<<<<<<<<<<<
 *             break
 * 
 */
      __pyx_v_turn = (__pyx_v_N / 2);

      /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":52
 *         if all_positive and i == N/2:
 *             turn = N/2
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":55
 * 
 *     # right derivative
 *     uturn = u[turn]             # <<<<<<<<<<<<<<
 *     uturn1 = u[turn+1]
 ...
 */
  __pyx_t_4 = __pyx_v_turn;
  if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_bshape_0_u;
  __pyx_v_uturn = (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_4, __pyx_bstride_0_u));

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":56
 *     # right derivative
 *     uturn = u[turn]
 *     uturn1 = u[turn+1]             # <<<<<<<<<<<<<<
 *     dright = (u[turn+1] - u[turn-1]) / (2.0*dx)
 * 
 */
  __pyx_t_26 = (__pyx_v_turn + 1);
  if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_bshape_0_u;
  __pyx_v_uturn1 = (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_26, __pyx_bstride_0_u));

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":57
 *     uturn = u[turn]
 *     uturn1 = u[turn+1]
 *     dright = (u[turn+1] - u[turn-1]) / (2.0*dx)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_27 = (__pyx_v_turn + 1);
  if (__pyx_t_27 < 0) __pyx_t_27 += __pyx_bshape_0_u;
  __pyx_t_28 = (__pyx_v_turn - 1);
  if (__pyx_t_28 < 0) __pyx_t_28 += __pyx_bshape_0_u;
  __pyx_v_dright = (((*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_27, __pyx_bstride_0_u)) - (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_28, __pyx_bstride_0_u))) / (2.0 * __pyx_v_dx));

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":61
 *     # outward integration up to turning point (one point beyond to get
 *     # derivative)
 ...
 * 
 */
  for (__pyx_t_29 = 1; __pyx_t_29 < (__pyx_v_turn + 1); __pyx_t_29+=1) {
    __pyx_v_i = __pyx_t_29;

    /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":62
 *     # derivative)
 *     for i in xrange(1, turn+1):
 *         u[i+1] = (-f0[i]*u[i] - fm[i]*u[i-1]) / fp[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_30 < 0) __pyx_t_30 += __pyx_bshape_0_f0;
    __pyx_t_31 = __pyx_v_i;
    if (__pyx_t_31 < 0) __pyx_t_31 += __pyx_bshape_0_u;
    __pyx_t_32 = __pyx_v_i;
    if (__pyx_t_32 < 0) __pyx_t_32 += __pyx_bshape_0_fm;
    __pyx_t_33 = (__pyx_v_i - 1);
    if (__pyx_t_33 < 0) __pyx_t_33 += __pyx_bshape_0_u;
    __pyx_t_34 = __pyx_v_i;
    if (__pyx_t_34 < 0) __pyx_t_34 += __pyx_bshape_0_fp;
    __pyx_t_35 = (__pyx_v_i + 1);
    if (__pyx_t_35 < 0) __pyx_t_35 += __pyx_bshape_0_u;
    *__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_35, __pyx_bstride_0_u) = ((((-(*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_f0.buf, __pyx_t_30, __pyx_bstride_0_f0))) * (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_31, __pyx_bstride_0_u))) - ((*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_fm.buf, __pyx_t_32, __pyx_bstride_0_fm)) * (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_33, __pyx_bstride_0_u)))) / (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_fp.buf, __pyx_t_34, __pyx_bstride_0_fp)));
  }

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":65
 * 
 *     # left derivative
 ...
 */
  __pyx_t_36 = (__pyx_v_turn + 1);
  if (__pyx_t_36 < 0) __pyx_t_36 += __pyx_bshape_0_u;
  __pyx_t_37 = (__pyx_v_turn - 1);
  if (__pyx_t_37 < 0) __pyx_t_37 += __pyx_bshape_0_u;
  __pyx_v_dleft = (((*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_36, __pyx_bstride_0_u)) - (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_37, __pyx_bstride_0_u))) / (2.0 * __pyx_v_dx));

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":68
 * 
 *     # rescale u in order to make it continuos
 *     scale = uturn / u[turn]             # <<<<<<<<<<<<<<
 *     #u[:turn+1] *= scale
 ...
 */
  __pyx_t_29 = __pyx_v_turn;
  if (__pyx_t_29 < 0) __pyx_t_29 += __pyx_bshape_0_u;
  __pyx_v_scale = (__pyx_v_uturn / (*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_29, __pyx_bstride_0_u)));

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":70
 *     scale = uturn / u[turn]
 *     #u[:turn+1] *= scale
 *     for j in xrange(0,turn+1): u[j] *= scale             # <<<<<<<<<<<<<<
 ...
 *     dleft *= scale
 */
  for (__pyx_t_38 = 0; __pyx_t_38 < (__pyx_v_turn + 1); __pyx_t_38+=1) {
    __pyx_v_j = __pyx_t_38;
    __pyx_t_39 = __pyx_v_j;
    if (__pyx_t_39 < 0) __pyx_t_39 += __pyx_bshape_0_u;
    *__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_39, __pyx_bstride_0_u) *= __pyx_v_scale;
  }

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":71
 *     #u[:turn+1] *= scale
 *     for j in xrange(0,turn+1): u[j] *= scale
 *     u[turn+1] = uturn1 # above overrode             # <<<<<<<<<<<<<<
 *     dleft *= scale
 * 
 */
  __pyx_t_40 = (__pyx_v_turn + 1);
  if (__pyx_t_40 < 0) __pyx_t_40 += __pyx_bshape_0_u;
  *__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_40, __pyx_bstride_0_u) = __pyx_v_uturn1;

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":72
 *     for j in xrange(0,turn+1): u[j] *= scale
 *     u[turn+1] = uturn1 # above overrode
 *     dleft *= scale             # <<<<<<<<<<<<<<
 * 
 *     # set the sign
 */
  __pyx_v_dleft *= __pyx_v_scale;

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":75
 * 
 *     # set the sign
 *     u = u*numpy.sign(u[1])             # <<<<<<<<<<<<<<
 * 
 *     # count nodes
 */
  __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_kp_numpy); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_1);
  __pyx_t_1 = PyObject_GetAttr(__pyx_1, __pyx_kp_sign); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_t_41 = 1;
  if (__pyx_t_41 < 0) __pyx_t_41 += __pyx_bshape_0_u;
  __pyx_t_2 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(__pyx_t_5shoot_double_t *, __pyx_bstruct_u.buf, __pyx_t_41, __pyx_bstride_0_u))); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GIVEREF(__pyx_t_2);
  __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_t_1, ((PyObject *)__pyx_t_8), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_8)); __pyx_t_8 = 0;
  __pyx_t_8 = PyNumber_Multiply(((PyObject *)__pyx_v_u), __pyx_t_2); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_8, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_42 = ((PyArrayObject *)__pyx_t_8);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_u);
    __pyx_t_38 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_u, (PyObject*)__pyx_t_42, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_38 < 0)) {
      PyErr_Fetch(&__pyx_t_7, &__pyx_t_6, &__pyx_t_5);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_u, (PyObject*)__pyx_v_u, &__Pyx_TypeInfo_nn___pyx_t_5shoot_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
        Py_XDECREF(__pyx_t_7); Py_XDECREF(__pyx_t_6); Py_XDECREF(__pyx_t_5);
        __Pyx_RaiseBufferFallbackError();
      } else {
        PyErr_Restore(__pyx_t_7, __pyx_t_6, __pyx_t_5);
    ...
    __pyx_bstride_0_u = __pyx_bstruct_u.strides[0];
    __pyx_bshape_0_u = __pyx_bstruct_u.shape[0];
    if (unlikely(__pyx_t_38 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_42 = 0;
  ...
  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":78
 * 
 *     # count nodes
 ...
 */
  __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_kp_numpy); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_1);
  __pyx_t_8 = PyObject_GetAttr(__pyx_1, __pyx_kp_sum); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_1 = PySequence_GetSlice(((PyObject *)__pyx_v_u), 0, (__pyx_v_turn - 1)); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_1);
  __pyx_2 = PySequence_GetSlice(((PyObject *)__pyx_v_u), 1, __pyx_v_turn); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_2);
  __pyx_t_2 = PyNumber_Multiply(__pyx_1, __pyx_2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
  __Pyx_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_t_1 = PyFloat_FromDouble(0.0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_43 = PyObject_RichCompare(__pyx_t_2, __pyx_t_1, Py_LT); if (unlikely(!__pyx_t_43)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_t_43);
  __Pyx_GIVEREF(__pyx_t_43);
  __pyx_t_43 = 0;
  __pyx_t_43 = PyObject_Call(__pyx_t_8, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_43)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_43);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __pyx_t_38 = __Pyx_PyInt_AsInt(__pyx_t_43); if (unlikely((__pyx_t_38 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_43); __pyx_t_43 = 0;
  __pyx_v_nodes = __pyx_t_38;

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":79
 *     # count nodes
 *     nodes = numpy.sum( (u[0:turn-1]*u[1:turn]) < 0.0 )
 *     derdisc = (dright - dleft) * uturn             # <<<<<<<<<<<<<<
 *     return u, nodes, turn, derdisc
 * 
 */
  __pyx_v_derdisc = ((__pyx_v_dright - __pyx_v_dleft) * __pyx_v_uturn);

  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":80
 *     nodes = numpy.sum( (u[0:turn-1]*u[1:turn]) < 0.0 )
 *     derdisc = (dright - dleft) * uturn
 *     return u, nodes, turn, derdisc             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_43 = PyInt_FromLong(__pyx_v_nodes); if (unlikely(!__pyx_t_43)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_43);
  __pyx_t_1 = PyInt_FromLong(__pyx_v_turn); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = PyFloat_FromDouble(__pyx_v_derdisc); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_2 = PyTuple_New(4); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_f0);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_u);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_c2);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_c1);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_c0);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_fm);
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("init"), (PyCFunction)__pyx_pf_5shoot_init, METH_NOARGS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("shoot"), (PyCFunction)__pyx_pf_5shoot_shoot, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_5shoot_shoot)},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_c0, __pyx_k_c0, sizeof(__pyx_k_c0), 1, 1, 1},
...
static int __Pyx_InitCachedBuiltins(void) {
  __pyx_builtin_xrange = __Pyx_GetName(__pyx_b, __pyx_kp_xrange); if (!__pyx_builtin_xrange) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initshoot(void); /*proto*/
PyMODINIT_FUNC initshoot(void)
#else
PyMODINIT_FUNC PyInit_shoot(void); /*proto*/
PyMODINIT_FUNC PyInit_shoot(void)
#endif
{
  PyObject *__pyx_1 = 0;
  #ifdef CYTHON_REFNANNY
  ...
  __pyx_refchk = __Pyx_Refnanny->NewContext("PyMODINIT_FUNC PyInit_shoot(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("shoot"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/home/ceresoli/AtomPy/Atomic/clib/shoot.pyx":1
